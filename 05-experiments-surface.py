...
# Save as DataFrame
nan_df_group.to_csv(path + 'excluded-grid-cells.csv')
...
dataset = netCDF4.Dataset(path + 'final-surface-forcing-grids.nc', 'w', format='NETCDF4_CLASSIC')
print('Creating %s' % path + 'final-surface-forcing-grids.nc')
...
print('Writing data to %s' % path + 'final-surface-forcing-grids.nc')
